...
* The tools features target to be an effective tasks management tool for individuals by its smart algorithms:
...
* While it is well known to be a tool for individuals and collaboration => many groups of people will regist and experiment eXo Cloud.
